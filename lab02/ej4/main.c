...
int main(int argc, char *argv[]) {
    ...
    printf("statistics for insertion_short\n");
    printf("time elapsed=%g,    comparisons: %10u,    swaps: %10u\n", calculate_elapsed_time(), comparisons_number(), swaps_number());
    
    
    /* las conclusiones que puedo sacar, es que el quick_sort es casi el mas rapido en la mayoria de los ejemplos, insertion sort es un punto medio en el promeido de los ejemplos, y selection sort es el mas lento de todos en promedio. */
