...
void reset_comparisons_counter(void);
/* Resets the comparisons_counter */

unsigned int comparisons_number(void);
/* Returns value of comparisons_counter
*/

void reset_swaps_counter(void);
/* Resets the counter of swaps */

unsigned int swaps_number(void);
...
double calculate_elapsed_time(void);
